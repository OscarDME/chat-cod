import { LANGUAGES, normalizeLangCode } from "@/lib/i18n";
...
export function buildAnaSystem(flow) {
  const code = normalizeLangCode(flow.language);
  const anaLang = LANGUAGES[code]?.anaName || "español";
...
Responde SIEMPRE en ${anaLang}, en tono sobrio y maduro, sin efusividad LATAM. Sé breve: 1-3 frases por respuesta. Sin signos de exclamación múltiples, sin MAYÚSCULAS gritadas, sin "amiga/querida/lindura".
