...
const STRINGS = {
  ...
  attachHintDesktop: {
    es: " o arrástrala al chat",
    pl: " lub przeciągnij ją do czatu",
    hu: " vagy húzd a beszélgetésbe",
    sk: " alebo ho potiahni do chatu",
    cs: " nebo ho přetáhni do chatu",
    ro: " sau trage-o în chat",
    bg: " или я провлачи в чата",
    hr: " ili je povuci u chat",
    sl: " ali jo povleci v klepet",
    et: " või lohista see vestlusse",
    lt: " arba vilkite į pokalbį",
  },
  dropHere: {
